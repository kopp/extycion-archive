...
set title "Ungedaempfte Schwingung: Videoanalyse" 
...
f(x) = A * sin(b*x) + C*cos(b*x) + E
g(x) = F * sin(G * x + H ) + I
GNUTERM = "wxt"
A = -0.00792971922316064
b = 99.9905554574814
C = -0.00972354134436501
E = 6.30383659561962
FIT_CONVERGED = 1
FIT_NDF = 314
FIT_STDFIT = 2.71890695713037
FIT_WSSR = 2321.23088304102
F = 4.87957629456047
G = 0.00890700355250132
H = 0.0101009671624407
I = 6.027676858253
plot "unged.data" using 4:6 with linespoints
## fit g(x) "unged.data" using 4:6 via F, G, H, I
#    EOF
