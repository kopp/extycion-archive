...
set xtics 20
set ytics 2.5
plot '10.data' using 1:(($2/2)**2):(2*$2*0.15) with yerrorbars title "1.0 A -- Messwerte" lt 1, f(x) title "1.0 A -- Fit" lt 1, '14.data' using 1:(($2/2)**2):(2*$2*0.15) with yerrorbars title "1.4 A -- Messwerte" lt 2, g(x) title "1.4 A -- Fit" lt 2, '18.data' using 1:(($2/2)**2):(2*$2*0.15) with yerrorbars title "1.8 A -- Messwerte" lt 3, i(x) title "1.8 A -- Fit" lt 3
