...
FIT_CONVERGED = 1
FIT_NDF = 12
FIT_STDFIT = 1.08861866883598
FIT_WSSR = 14.2210872736588
plot '10.data' using 1:(($2/2)**2) title "1.0 A -- Messwerte", f(x) title "1.0 A -- Fit", '14.data' using 1:(($2/2)**2) title "1.4 A -- Messwerte", g(x) title "1.4 A -- Fit", '18.data' using 1:(($2/2)**2) title "1.8 A -- Messwerte", h(x) title "1.8 A -- Fit"
## fit h(x) '18.data' using 1:(($2/2)**2) via c
#    EOF
